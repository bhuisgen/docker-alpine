...
#
$Conf{TopDir}      = '/var/lib/backuppc/data';
$Conf{ConfDir}     = '/var/lib/backuppc/etc';
...
# This setting only matters if $Conf{XferMethod} = 'rsync'.
#
$Conf{RsyncSshArgs} = ['-e', '$sshPath -l backuppc -o ServerAliveInterval=60'];
...
#
$Conf{ArchiveDest} = '/var/lib/backuppc/tmp';
